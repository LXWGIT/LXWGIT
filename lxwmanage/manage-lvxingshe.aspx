<%@ Page Title="" Language="C#" MasterPageFile="~/master/MasterPageindex.master" AutoEventWireup="true" CodeFile="manage-lvxingshe.aspx.cs" Inherits="lxwmanage_manage_lvxingshe" %>
...
<ul class="u1">
<li>
旅行社名称　<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
    　城市　<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
    　<asp:Button ID="Button12" runat="server" Text="搜索" />
    </li>
   <li>
    <asp:Button ID="Button7" runat="server" Text="添加旅行社" Width="78px" />　　<asp:Button ID="Button8" runat="server" Text="Excel导入" />
</li>
</ul>
<ul class="u2">
<li>
